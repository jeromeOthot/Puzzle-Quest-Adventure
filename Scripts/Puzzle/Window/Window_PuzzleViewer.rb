...
class Window_PuzzleViewer < Window_Base
  ...
  def initialize(x, y)
    ...
    @puzzle_viewport = Viewport.new( x, y,  350, 350 )
  ...
  def createGemOnBoardWithCode( code, posX, posY)
    ...
    case code
    when "x"
      gem = @gemsFactory.create_gem(0, (51 + 27*posX)+15, (3+27*posY)+70)
    when "f"
    ...
    when "l"
      gem = @gemsFactory.create_gem(5, (51 + 27*posX)+15, (3+27*posY)+70)
    when "i"
      gem = @gemsFactory.create_gem(7, (51 + 27*posX)+15, (3+27*posY)+70)
    when "t"
      gem = @gemsFactory.create_gem(8,  (51 + 27*posX)+15, (3+27*posY)+70)
    when "d"
      gem = @gemsFactory.create_gem(8,  (51 + 27*posX)+15, (3+27*posY)+70)
    end
