class Scene_Puzzle < Scene_MenuBase
  ...
  attr_accessor   :window_puzzleConsole
  attr_accessor   :window_puzzleBoard
  attr_accessor   :window_heroMagicBars
  attr_accessor   :window_gameVs
  attr_accessor   :window_upLeft
  attr_accessor   :window_puzzleBoard
  ...
  def startPuzzle
    ...
    create_windowPuzzleBoard
    create_windowPuzzleConsole
  ...
  def checkBreakButton
    if(Input.trigger?(Input::B) )
      ...
      @command_window.set_handler(:QuitPuzzle, method(:command_quitPuzzle))
  ...
  def openVictoryWindow
    ...
    #@window_puzzleBoard.contents.blt(2, 2, bitmap_board, Rect.new(0, 0, 315, 45))
  ...
  def hideAllWindow
    ...
    @window_puzzleBoard.opacity = 0
    @window_puzzleBoard.contents_opacity = 0
...
#############################################################################
  ...
  def create_windowPuzzleBoard
    @window_puzzleBoard = Window_PuzzleBoard.new(196, 165, 248, 250, 8)

    #On part le combat
    @gamePuzzle = Game_Puzzle.new(@window_puzzleBoard, @noPuzzle)

  end

  def create_windowPuzzleConsole
    @window_puzzleConsole = Window_PuzzleConsole.new(0, 415, 640, 65)
  end
