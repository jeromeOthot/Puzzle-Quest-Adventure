...
#~     puts("GAME INTERPRETER")
#~     puts(get_character(-1))
#~     puts(get_character(0))
#~     puts(get_character(1))

#~     if character
#~       character.animation_id = 1#@params[1]
#~        create_fiber()
#~       Fiber.yield while character.animation_id > 0 if true#@params[2]
#~     end
#~   end
