...
module PearlBars
  ...
  HP_Color = [Color.new(205, 0, 0, 200),       Color.new(160, 0, 0,  200)]
  MP_Color = [Color.new(0, 0, 205, 200),   Color.new(0, 0, 160, 200)]
  EX_Color = [Color.new(0, 205, 0, 200),   Color.new(0, 160, 0, 200)]
