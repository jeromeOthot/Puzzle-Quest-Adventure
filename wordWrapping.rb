...
#    Thread : http://www.rpgmakervxace.net/topic/6964-word-wrapping-message-boxes/
#------------------------------------------------------------------------
...
# Version the Sixth:
#   Fixed problems with collapsed whitespace not wrapping words right.
#------------------------------------------------------------------------
...
class Window_Base < Window
  ...
  def process_character(c, text, pos)
    ...
    if @wordwrap && c =~ /[ \t]/
      ...
      if pos[:x] + get_next_word_size(c, text) > contents.width
